...
public class DickensController {
     ...
     */
    @Label("DickensEvent")
    @Description("Used for recording events in our DickensController")
    static class DickensEvent extends Event {
        // Message.
        @Label("Message")
        String message;
    }
    ...
    ResponseEntity<String> whatTheDickens() {
        DickensEvent event = new DickensEvent();
        event.message = "Prose being generated";
        event.commit();
    ...
    ResponseEntity<String> whatTheDickensN(@PathVariable int number) {
        return ResponseEntity.ok(wtd.generate(number));
    }
}
