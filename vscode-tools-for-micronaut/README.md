...
![Application View](images/mn-activity-view-run.png)

In the first panel of the Micornaut Activity View we can see our application.  By clicking on the various icons that are shown when we hover the mouse over the application name we can start, debug and stop our application.

![](images/RMIL_Technology_Laptop_Bark_RGB_50.png#input)

Over to you:
* Start the application, and then stop it, using the view.
* Add a brak point to your controller class and then use the Micornaut Activity view to debug your application.
* run the application in continuous mode. Make a change to the text generated by the controller and see what happens.
